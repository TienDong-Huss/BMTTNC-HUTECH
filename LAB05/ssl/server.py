...
# Tạo SSL context chung
context = ssl.SSLContext(ssl.PROTOCOL_TLS)
context.load_cert_chain(certfile="M:\BMTTNC-HUTECH\LAB05\ssl\certificates\server-cert.crt",
                        keyfile="M:\BMTTNC-HUTECH\LAB05\ssl\certificates\server-key.key")
